...
\[\begin{tikzcd}
	{\bRd f_! (E \underline{\otimes}f^* (F)) } & {\bRd f_! (E) \underline{\otimes} F. }
...
$$
\bRd f_* (E) \underline{\otimes} F \to \bRd f_* (E \underline{\otimes} f^* F)
$$
...
$$
\bRd f_! (E) \underline{\otimes} \bRd g_! (F) \isomlong \bRd h_! (p^* E \underline{\otimes}q^* F).
$$
}
\vskip .3cm
...
$$
\bRd f_! (E) \underline{\otimes} \bRd g_! (F) \isomlong \bRd f_! (E \underline{\otimes}f^* \bRd g_! (F)).
\leqno{(1.1.10.1)}
$$
...
$$
\bRd f_! (E) \underline{\otimes} \bRd g_! (F) \isomlong \bRd f_! (E \underline{\otimes} \bRd p_! q^* (F)).
$$
La formule de projection (1.1.7) pour le morphism $p$ montre que
$$
E \underline{\otimes} \bRd p_! q^* (F) \isomlong \bRd p_! (p^* E \underline{\otimes} q^* F),
$$
d'où
$$
\bRd f_!(E \underline{\otimes} \bRd p_!q^* (F)) \isomlong \bRd f_! \bRd p_! (p^* E \underline{\otimes} q^* F),
$$
...
$$
\bRd f^!(F) = \bRd i^! (p^* F \underline{\otimes}_{\mathbf{Z}_\ell}\mathbf{Z}_\ell(r))[2r],
$$
...
\[\begin{tikzcd}
	{\bRd j^!(f^* F)} && {g^* (F) \underline{\otimes}_{\mathbf{Z}_\ell}\mathbf{Z}_\ell (-d)[-2d].}
...
$$
\bRd j_* (g^* F \underline{\otimes}_{\mathbf{Z}_\ell}\mathbf{Z}_\ell(-d)[-2d]) \to f^* F,
$$
soit, d'après la formule de projection (I 7.7.12 (iv)),
$$
f^* F \underline{\otimes}_{\mathbf{Z}_\ell} \bRd j_* (\mathbf{Z}_\ell(-d)[-2d]) \to f^* F.
$$
...
$$
\bRd f^! \bRd{\cHom}_A (E, F) \isomlong f^* \bRd{\cHom}_A (E, F) \underline{\otimes}_{\mathbf{Z}_\ell}\mathbf{Z}_\ell(r)[2r];
$$
...
$$
B \underline{\otimes}_A \bRd f_! (E) \to \bRd f_!(B \underline{\otimes}_A E)
$$
