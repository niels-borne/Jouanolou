...
$$
où pour tout $q$, $I_q$ est un $A_q$--Moule injectif. L'entier $q \leq n$ étant fixé, pour tout entier $p \geq n$, le $A_q$--Module $E_p/J^{q+1}E_p$ est plat, donc $\cHom_A (E_p, I_q)$ est un $A_q$--Module injectif. Les hypothèses sur $T$ et $A$ impliquent que la catégorie $A_q-\Mod_T$ est localement noethérienne, et par suite qu'une limite inductive filtrante de $A_q$--Modules injectifs est un $A_q$--Module injectif. En particulier
$$
...
$$
Les conditions du lemme (7.5.1) étant satisfaites en particulier par les $A$-faisceaux pseudo-injectifs, on peut, en utilisant des résolutions pseudo-injectives, définir un foncteur dérivé
$$
