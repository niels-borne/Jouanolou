...
\vskip .3cm
{
Définition {\bf 6.7.1}. --- \it Soit $(X, A, J)$ un idéotope. On dit qu'un $A$-faisceau sur $X$ est \emph{fortement plat} s'il est isomorphe dans $A-\fsc(X)$ à un $A$-faisceau $F = (F_n)_{n \in \mathbf{N}}$ tel que pour tout $n \in \mathbf{N}$ ele $A_{nX}$--Module $F_n$ soit plat. 
}
\vskip .3cm
